...
class DioSigle {
  ...
  /// 请求的URL前缀
  static const String BASE_URL = GlobalConst.baseUrl;//"http://localhost:8080";
  /// 是否开启网络缓存,默认false
  ...
  factory DioSigle() => _instance ?? DioSigle._internal();

  static DioSigle? getInstance() {
    _instance ?? DioSigle._internal();
    return _instance;
  }
  _init() {
    /// 初始化基本选项
...
// import 'package:bezier/values/values.dart';
// import 'utils.dart';
